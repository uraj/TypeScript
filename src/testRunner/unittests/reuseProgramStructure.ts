namespace ts {
    ...
    function checkResolvedModulesCache(program: Program, fileName: string, expectedContent: ESMap<string, ResolvedModule | undefined> | undefined): void {
        checkCache("resolved modules", program, fileName, expectedContent, f => program.getPerFileModuleResolutions().get(f.path), checkResolvedModule);
    }
    ...
    function checkResolvedTypeDirectivesCache(program: Program, fileName: string, expectedContent: ESMap<string, ResolvedTypeReferenceDirective> | undefined): void {
        checkCache("resolved type directives", program, fileName, expectedContent, f => program.getPerFileTypeReferenceResolutions().get(f.path), checkResolvedTypeDirective);
    }
